...
namespace SmartChargingApi.Groups.Features.AddChargeStation.v1;

public sealed record AddChargeStation(Guid GroupId, string Name, IReadOnlyCollection<ConnectorDto> Connectors)
{
