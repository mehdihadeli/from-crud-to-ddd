...
namespace SmartCharging.Shared.Data.Migrations
{
    ...
    [Migration("20250814125018_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartChargingApi.Groups.Models.ChargeStation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("SmartChargingApi.Groups.Models.Connector", b =>
                {
            ...
            modelBuilder.Entity("SmartChargingApi.Groups.Models.Group", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("SmartChargingApi.Groups.Models.ChargeStation", b =>
                {
                    b.HasOne("SmartChargingApi.Groups.Models.Group", null)
                    ...
                    b.OwnsOne("SmartChargingApi.Groups.Models.ValueObjects.Name", "Name", b1 =>
                        {
            ...
            modelBuilder.Entity("SmartChargingApi.Groups.Models.Connector", b =>
                {
                    b.HasOne("SmartChargingApi.Groups.Models.ChargeStation", null)
                        .WithMany("Connectors")
                        .HasForeignKey("ChargeStationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                    ...
                    b.OwnsOne("SmartChargingApi.Groups.Models.ValueObjects.CurrentInAmps", "MaxCurrentInAmps", b1 =>
                        {
            ...
            modelBuilder.Entity("SmartChargingApi.Groups.Models.Group", b =>
                {
                    b.OwnsOne("SmartChargingApi.Groups.Models.ValueObjects.CurrentInAmps", "CapacityInAmps", b1 =>
                        {
